...
class Page3(QWidget):
    ...
    def acquisition_process(self):
        ...
        self.mm.configAxis(self.camMotor, MICRO_STEPS.ustep_8,
        ...
        if stop_exec:
            ...
            self.l2.setText('Total time taken: '+str(elapsed_hr) +
                            ' hrs '+str(elapsed_min) + ' mins')
    ...
    def update_label(self):
        ...
        if process_complete or stop_exec:
            ...
            elapsed_hr = int(elapsed_time/3600)
            elapsed_min = int(elapsed_time/60) - 60*elapsed_hr
            self.l2.setText('     Time Elapsed: '+str(elapsed_hr) +
                            ' hrs '+str(elapsed_min) + ' mins')
